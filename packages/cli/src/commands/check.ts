...
import { CliUsageError, setCommandExitCode } from "../utils/commandResult.js";
import { swallowedValueMessage } from "../utils/reject-unknown-flags.js";
...
export function parseFrameCheck(value: unknown): FrameCheckOptions | undefined {
  ...
  if (value.startsWith("-")) throw new CliUsageError(swallowedValueMessage("frame-check", value));
